...
from hat.archs.focalsr_utils import Local_Base
from basicsr.archs.arch_util import trunc_normal_
from hat.archs.focalsr_utils import HAB, OCAB, window_partition, SFB
from hat.archs.focalsr_utils import PatchEmbed, PatchUnEmbed, Upsample
...
class SFTB(nn.Module):
    """Fourier Transformer Block (SFTB).
...
@ARCH_REGISTRY.register()
class FocalSR_Local(Local_Base, FocalSR):
    def __init__(self, *args, train_size=(1, 3, 64, 64), fast_imp=False, **kwargs):
        Local_Base.__init__(self)
        FocalSR.__init__(self, *args, **kwargs)
